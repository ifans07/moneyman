...
<section>
    <div class="container">
        <div>
            ...
            <div class="my-3">
                <a href="<?= base_url('') ?>" class="btn btn-primary fw-medium"><i class="fa-solid fa-home"></i> Home</a>
        ...
        <div id="targetSavingsGrid" class="grid-container">

        </div>

        <!-- Grid Panjang (Detail) -->
        <div id="grid-detail" class="row row-cols-1 g-4 d-none">
        ...
        <!-- Grid Kotak (Persegi) -->
        <div id="grid-square" class="row row-cols-2 row-cols-md-3 row-cols-lg-4 g-4 d-none">
            <!-- Card Kotak -->
        ...
        <div id="grid-rectangle" class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 d-none">
                ...
                <form id="targetSavingsForm">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="selectedIcon" readonly required onclick="openIconModal()">
...
$(document).ready(function () {
    ...
    // Fungsi untuk mengambil data target savings dan menampilkan dalam grid
    function fetchTargetSavings(view = 'detail') {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    data.forEach(function (target, index) {
                        ...
                        let remainingAmount = target.target_amount - target.total_saved;
                        let monthlyInstallment = target.total_saved || 0;
                        ...
                        // Membuat struktur berdasarkan view yang dipilih
                        if (view === 'detail') {
                            content += `
                                <div id="grid-detail" class="row row-cols-1 g-4 d-none">
                ...
                <div class="card shadow-sm p-3" style="border-radius: 12px;">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <small class="text-muted d-block mb-1">Rp${target.total_saved} / Rp${target.target_amount}</small>
                            <div class="progress mt-2 mb-0" style="height: 6px; border-radius: 5px;">
                                <div class="progress-bar" role="progressbar" style="width: ${target.progress}%; background-color: #384c57;" aria-valuenow="42" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        ...
                        <div class="text-end" style="font-size: 12px;">
                            <small>Estimasi Selesai</small>
                            <br>
                            <strong>${monthsRemaining} bulan</strong>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card card-square shadow-sm">
                    ...
                    <!-- Tooltip untuk Estimasi -->
                    <div class="mt-2" data-bs-toggle="tooltip" title="Estimasi selesai dalam ${monthsRemaining} bulan">
                        <i class="fas fa-calendar-alt text-secondary"></i>
                        <small class="text-secondary"> ${monthsRemaining} bulan lagi</small>
                    </div>
                </div>
            </div>
            <!-- Tambahkan lebih banyak card di sini jika diperlukan -->
        ...
        <div id="grid-rectangle" class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 d-none">
                ...
                <div class="card shadow-sm" style="border-radius: 12px;">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <small class="card-text mb-0 text-muted d-block text-form">Rp${target.total_saved} / Rp${target.target_amount}</small>
                            <small class="card-text text-muted text-form mb-0"><i class="fa-solid fa-calendar-alt"></i> ${monthsRemaining} bulan lagi</small>
                        </div>
                        <!-- Lingkaran Progress di sebelah kanan -->
            ...
            <!-- Tambahkan lebih banyak card di sini jika diperlukan -->
                    ...
                    $('#targetSavingsGrid').html(content);
                }
            });
        }
        ...
        function changeView(view) {
            fetchTargetSavings(view);
        }

        // Memuat tampilan default saat halaman pertama kali dimuat
        $(document).ready(function () {
            fetchTargetSavings('detail'); // Default view
        });
    ...
    $('#targetSavingsForm').submit(function (event) {
        ...
        let url = id ? `/api/targetsavings/${id}` : '/api/targetsavings';
    ...
    window.openEditModal = function (id) {
        $.ajax({
            ...
            success: function (data) {
                ...
                $('#targetSavingsName').val(data.name);
                $('#targetAmount').val(data.target_amount);
                $('#savedAmount').val(data.saved_amount);
                $('#selectedIcon').val(data.icon_class);
