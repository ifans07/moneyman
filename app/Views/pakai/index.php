            ...
            <div>
                ...
                <div class="row row-cols-1 row-cols-lg-2 g-2">
                    ...
                    <?php foreach($pakai as $p): ?>
                        ...
                        ?>
                    <div class="col" data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-title="<?= $startDate . " - ". $endDate ?>">
                        <div class="p-3 shadow-custom rounded-4" style="background-color: #fafafa">
                            <div class="card-body d-flex align-items-center">
                                ...
                                <div class="circular-progress ms-3 me-1 shadow-sm" style="background: conic-gradient(#384c57 100%, #e0e0e0 100%);">
                                    <span><?= $interval->days ?></span>
                                </div>
                                <div class="d-none d-sm-flex">
                                    <?php if($p['tanggal_selesai'] == '0000-00-00'): ?>
                                        <div class="circular-progress me-1" style="background: conic-gradient(#384c57 100%, #e0e0e0 100%); cursor: pointer;" onclick="updatePakaiModal(<?= $p['id'] ?>)">
                                    ...
                                    <?php endif; ?>
                                    <div class="circular-progress" style="background: conic-gradient(#384c57 100%, #e0e0e0 100%); cursor: pointer;">
            ...
            <div class="modal-body" style="background-color: var(--bs-bg)">
                <form id="addPakaiForm" action="<?= base_url('/pakai/save') ?>" method="post">
                    ...
                    <div>
                        ...
                        <input type="date" class="form-select" id="tanggal-keluar" name="tanggal_mulai">
                    </div>
            ...
            <div class="modal-body" style="background-color: var(--bs-bg)">
                <form id="updatePakaiForm">
                    ...
                    <div>
                        ...
                        <input type="date" class="form-select" id="tanggal-selesai" name="tanggal_mulai">
                    </div>
